  ...
  <el-dialog v-model="dialogVisible" title="信息录入" width="60%" :before-close="handleClose" center :append-to-body="true"
    ...
    <el-descriptions class="margin-top" :column="2" :size="size" border>
      <el-descriptions-item>
        ...
        <el-input v-model="dialogTableData.teacherName" placeholder="请输入" disabled></el-input>
      </el-descriptions-item>
      ...
      <el-descriptions-item>
        ...
        <el-input v-model="dialogTableData.teacherId" placeholder="请输入" disabled></el-input>
      </el-descriptions-item>
      ...
      <el-descriptions-item>
        ...
        <el-input v-model="dialogTableData.email" placeholder="请输入"></el-input>
      </el-descriptions-item>
      ...
      <el-descriptions-item>
        ...
        <el-input v-model="dialogTableData.title" placeholder="请输入"></el-input>
      </el-descriptions-item>
      <el-descriptions-item>
        <template #label>
          <div class="cell-item">
        ...
        <el-input v-model="dialogTableData.education" placeholder="请输入"></el-input>
      </el-descriptions-item>
      <el-descriptions-item>
        <template #label>
          <div class="cell-item">
        ...
        <el-select v-model="dialogTableData.category" style="width: 100px" placeholder="请选择">
